...
const detailedBlogs = {
  1: () => import('./technology/cloud-computing.js').then(m => m.cloudComputingBlog),
  2: () => import('./technology/ai-revolution.js').then(m => m.aiRevolutionBlog),
  3: () => import('./technology/quantum-computing.js').then(m => m.quantumComputingBlog),
  4: () => import('./technology/5g-connectivity.js').then(m => m.fiveGConnectivityBlog),
  5: () => import('./technology/cybersecurity-remote.js').then(m => m.cybersecurityRemoteBlog),
  6: () => import('./development/react-19.js').then(m => m.react19Blog),
  7: () => import('./development/scalable-apis.js').then(m => m.scalableApisBlog),
  8: () => import('./development/javascript-patterns.js').then(m => m.javascriptPatternsBlog),
  9: () => import('./development/docker-kubernetes.js').then(m => m.dockerKubernetesBlog),
  10: () => import('./development/testing-strategies.js').then(m => m.testingStrategiesBlog),
  11: () => import('./design/ai-web-design.js').then(m => m.aiWebDesignBlog),
  12: () => import('./design/design-systems.js').then(m => m.designSystemsBlog),
  13: () => import('./design/accessibility-design.js').then(m => m.accessibilityDesignBlog),
  14: () => import('./design/motion-design.js').then(m => m.motionDesignBlog),
  15: () => import('./design/color-theory.js').then(m => m.colorTheoryBlog),
  16: () => import('./business/digital-transformation.js').then(m => m.digitalTransformationBlog),
  21: () => import('./marketing/digital-marketing-trends.js').then(m => m.digitalMarketingTrendsBlog),
  26: () => import('./lifestyle/work-life-balance.js').then(m => m.workLifeBalanceBlog)
};
...
const getAvailableBlogIds = () => Object.keys(detailedBlogs).map(Number);
...
export const blogApiResponse = {
  ...
  },
  {
    ...
    content: null,
    featuredImage: "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=800&h=400&fit=crop",
  ...
  // Development
  {
    ...
    comments: 56,
    status: "published",
    seoTitle: "Getting Started with React 19 - New Features & Migration Guide",
    seoDescription: "Learn about React 19's groundbreaking features including the React Compiler, enhanced Suspense, and migration strategies.",
    featured: true
  },
  {
    id: 7,
  ...
  // Design
  {
    ...
    seoDescription: "Discover how AI is revolutionizing web design through automated layouts, intelligent color palettes, and personalized experiences.",
    featured: false
  },
  {
    id: 12,
    ...
    content: null,
    featuredImage: "https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?w=800&h=400&fit=crop",
  ...
  },
  {
    ...
    comments: 31,
    status: "published",
    seoTitle: "Color Theory in Digital Design - Psychology and Application Guide",
    seoDescription: "Master color theory for digital design including color psychology, accessibility considerations, and effective palette creation.",
    featured: false
  },
  ...
  },
  {
    ...
    currentPage: 1,
    postsPerPage: 10,
    categories: ["Technology", "Development", "Design", "Business", "Marketing", "Lifestyle"]
  },
  timestamp: "2024-12-15T10:30:00Z"
};

// Extract and filter posts for easy use (simulating API data extraction)
export const blogPosts = blogApiResponse.data.posts.filter(post => getAvailableBlogIds().includes(post.id));